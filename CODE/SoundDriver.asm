...
;   EF - SET FM VOICE
@cfSetFMInst:
    ; CHECK IF USING BUILT IN INSTRUMENTS
    LD L, <FMTrack0.Instrument
    LD (HL), A
    CP A, $10
    RET C
    ; SET INSTRUMENT TO CUSTOM
    LD (HL), $00
...
.SECTION "Volume Envelope Table" BANK BANK_SOUND SLOT 2 FREE BITWINDOW 8 RETURNORG
VolumeEnvTable:
...
.SECTION "Speed Up Tempo Table (FM)" BANK BANK_SOUND SLOT 2 FREE BITWINDOW 8 RETURNORG
SpeedUpTempoTableFM:
...
.SECTION "Patch Envelope Table" BANK BANK_SOUND SLOT 2 FREE BITWINDOW 8 RETURNORG
FMPatchEnvTable:
    .dw PatchEnv01
    .dw PatchEnv02
    .dw PatchEnv03
...
.SECTION "PatchEnv01" BANK BANK_SOUND SLOT 2 FREE BITWINDOW 8 RETURNORG
PatchEnv01:
    .db $09, $05, $80
.ENDS

.SECTION "PatchEnv02" BANK BANK_SOUND SLOT 2 FREE BITWINDOW 8 RETURNORG
PatchEnv02:
    .db $02, $01, $80
.ENDS

.SECTION "PatchEnv03" BANK BANK_SOUND SLOT 2 FREE BITWINDOW 8 RETURNORG
PatchEnv03:
    .db $02, $01, $80
.ENDS

.SECTION "PatchEnv04" BANK BANK_SOUND SLOT 2 FREE BITWINDOW 8 RETURNORG
PatchEnv04:
    .db $0C, $0B, $80
.ENDS

.SECTION "PatchEnv05" BANK BANK_SOUND SLOT 2 FREE BITWINDOW 8 RETURNORG
PatchEnv05:
    .db $0C, $03, $80
.ENDS

.SECTION "PatchEnv06" BANK BANK_SOUND SLOT 2 FREE BITWINDOW 8 RETURNORG
PatchEnv06:
    .db $07, $01, $80
.ENDS

.SECTION "PatchEnv07" BANK BANK_SOUND SLOT 2 FREE BITWINDOW 8 RETURNORG
PatchEnv07:
    .db $07, $01, $80
.ENDS

.SECTION "PatchEnv08" BANK BANK_SOUND SLOT 2 FREE BITWINDOW 8 RETURNORG
PatchEnv08:
    .db $0C, $08, $80
.ENDS

.SECTION "PatchEnv09 (HI-HAT)" BANK BANK_SOUND SLOT 2 FREE BITWINDOW 8 RETURNORG
PatchEnv09:
    .db $05, $04, $80
.ENDS

.SECTION "PatchEnv0A (HI-HAT)" BANK BANK_SOUND SLOT 2 FREE BITWINDOW 8 RETURNORG
PatchEnv0A:
    .db $05, $04, $80
.ENDS

.SECTION "PatchEnv0B" BANK BANK_SOUND SLOT 2 FREE BITWINDOW 8 RETURNORG
PatchEnv0B:
    .db $07, $03, $80
.ENDS

.SECTION "PatchEnv0C" BANK BANK_SOUND SLOT 2 FREE BITWINDOW 8 RETURNORG
PatchEnv0C:
    .db $09, $08, $80
.ENDS

.SECTION "PatchEnv0D" BANK BANK_SOUND SLOT 2 FREE BITWINDOW 8 RETURNORG
PatchEnv0D:
    ;.db $0E, $02, $80
    .db $0C, $02, $80
.ENDS

.SECTION "PatchEnv0E" BANK BANK_SOUND SLOT 2 FREE BITWINDOW 8 RETURNORG
PatchEnv0E:
    .db $0C, $03, $80
.ENDS

.SECTION "PatchEnv0F (SNARE)" BANK BANK_SOUND SLOT 2 FREE BITWINDOW 8 RETURNORG
PatchEnv0F:
    .db $0F, $00, $80
.ENDS

.SECTION "PatchEnv10" BANK BANK_SOUND SLOT 2 FREE BITWINDOW 8 RETURNORG
PatchEnv10:
    .db $04, $07, $80
.ENDS

.SECTION "PatchEnv11" BANK BANK_SOUND SLOT 2 FREE BITWINDOW 8 RETURNORG
PatchEnv11:
    .db $0D, $0A, $80
.ENDS

.SECTION "PatchEnv12 (POWER SNARE)" BANK BANK_SOUND SLOT 2 FREE BITWINDOW 8 RETURNORG
PatchEnv12:
    .db $00, $80
.ENDS

.SECTION "PatchEnv13 (KICK)" BANK BANK_SOUND SLOT 2 FREE BITWINDOW 8 RETURNORG
PatchEnv13:
    .db $0A, $04, $80 ;$05, $80
.ENDS

.SECTION "PatchEnv14 (CONGA)" BANK BANK_SOUND SLOT 2 FREE BITWINDOW 8 RETURNORG
PatchEnv14:
    .db $0C, $05, $80
.ENDS

.SECTION "PatchEnv15 (OVERDRIVEN GUITAR)" BANK BANK_SOUND SLOT 2 FREE BITWINDOW 8 RETURNORG
PatchEnv15:
    .db $0B, $04, $80;$0E, $0A, $80
.ENDS

.SECTION "PatchEnv16 (ORCH HIT)" BANK BANK_SOUND SLOT 2 FREE BITWINDOW 8 RETURNORG
PatchEnv16:
    .db $00, $80
.ENDS

.SECTION "PatchEnv17 (CLAP?)" BANK BANK_SOUND SLOT 2 FREE BITWINDOW 8 RETURNORG
PatchEnv17:
    .db $00, $80
.ENDS

.SECTION "PatchEnv18 (DRUM?)" BANK BANK_SOUND SLOT 2 FREE BITWINDOW 8 RETURNORG
PatchEnv18:
    .db $00, $80
.ENDS

.SECTION "PatchEnv19" BANK BANK_SOUND SLOT 2 FREE BITWINDOW 8 RETURNORG
PatchEnv19:
    .db $00, $80
.ENDS

.SECTION "PatchEnv1A" BANK BANK_SOUND SLOT 2 FREE BITWINDOW 8 RETURNORG
PatchEnv1A:
    .db $00, $80
.ENDS
...
.SECTION "FM Volume Envelope Table" BANK BANK_SOUND SLOT 2 FREE BITWINDOW 8 RETURNORG
FMVolumeEnvTable:
...
.SECTION "FMVolEnv01" BANK BANK_SOUND SLOT 2 FREE BITWINDOW 8 RETURNORG
FMVolEnv01:
...
.SECTION "FMVolEnv02" BANK BANK_SOUND SLOT 2 FREE BITWINDOW 8 RETURNORG
FMVolEnv02:
    .db $00, $00, $00, $00, $00, $00, $01, $01, $01, $02, $02, $03, $03, $04, $04, $05
    .db $05, $06, $07, $08, $0C, $0F, $80
.ENDS

.SECTION "FMVolEnv03" BANK BANK_SOUND SLOT 2 FREE BITWINDOW 8 RETURNORG
FMVolEnv03:
    .db $00, $00, $00, $00, $00, //$00, $00, $00, $00, 
    .db $03, $06, $09, $0C, $0F, $80
.ENDS

.SECTION "FMVolEnv04" BANK BANK_SOUND SLOT 2 FREE BITWINDOW 8 RETURNORG
FMVolEnv04:
    .db $00, $03, $09, $0C, $0F, $80
.ENDS

.SECTION "FMVolEnv05" BANK BANK_SOUND SLOT 2 FREE BITWINDOW 8 RETURNORG
FMVolEnv05:
    .db $00, $01, $03, $05, $09, $0C, $0F, $80
.ENDS

.SECTION "FMVolEnv06" BANK BANK_SOUND SLOT 2 FREE BITWINDOW 8 RETURNORG
FMVolEnv06:
    .db $04, $04, $02, $02, $00, $80
.ENDS

.SECTION "FMVolEnv07" BANK BANK_SOUND SLOT 2 FREE BITWINDOW 8 RETURNORG
FMVolEnv07:
    .db $00, $00, $01, $01, $01, $02, $02, $02, $02, $03, $03, $03, $04, $80
.ENDS

.SECTION "FMVolEnv08" BANK BANK_SOUND SLOT 2 FREE BITWINDOW 8 RETURNORG
FMVolEnv08:
    .db $00, $01, $01, $02, $02, $02, $02, $02, $03, $03, $03, $03, $04, $04, $04, $04
    .db $04, $04, $06, $80
.ENDS

.SECTION "FMVolEnv09" BANK BANK_SOUND SLOT 2 FREE BITWINDOW 8 RETURNORG
FMVolEnv09:
    .db $04, $04, $04, $04, $04, $03, $03, $03, $03, $03, $02, $02, $02, $02, $02, $01
    .db $01, $01, $01, $01, $00, $80
.ENDS

.SECTION "FMVolEnv0A" BANK BANK_SOUND SLOT 2 FREE BITWINDOW 8 RETURNORG
FMVolEnv0A:
...
.SECTION "Custom Instrument Table" BANK BANK_SOUND SLOT 2 FREE BITWINDOW 8 RETURNORG
FMInstrumentTable:
